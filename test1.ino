...
//Array codes
//Theshold finder
int pins[7] = { A2,A7, A6, A1, A3, A4, A5};
int sensorArray[7];
int sensorValue = 0;
...
void rightfirst() {
  ...
  // moveforward(50);
  readArray();
  if(sensorValue==0b1111110 || sensorValue==0b1111111 ||sensorValue==0b1111100 ||sensorValue == 0b1111000 ||sensorValue==0b0111000 )
  {
    end();
  }
...
void leftfirst() {
  ...
  // moveforward(50);
  readArray();
  if(sensorValue==0b1111110 || sensorValue==0b1111111 ||sensorValue==0b1111100  ||sensorValue==0b0111000 )
  {
    end();
  }
